    ...
    <div class="my-4">
        ...
        <input class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="name" name="name" type="text" placeholder="Digite um Nome" aria-label="Name" value="{{ $admin->name ?? old('name')}}">
    </div>
    <div class="my-4">
        <label class="block text-sm text-gray-600" for="email">Email</label>
        <input class="w-full px-5  py-2 text-gray-700 bg-gray-200 rounded" id="email" name="email" type="email" placeholder="Digite um E-mail" aria-label="Email" value="{{ $admin->email ?? old('email')}}">
    </div>
